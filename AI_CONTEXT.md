...
- **P2 Profit-Take Relief** (TEMPORARY SPRINT FIX — May 2026; revert after sprint window):
  ...
  - **Mild-loss micro rotation (May 2026)**: HOLD with unrealized **-7% to -1%**, WMATIC **$5–$8**, **1+** idle cycle → capped sell (~30%, max **$2.25** notional, floor **$1.25**); log `[Main Strategy] Small idle rotation triggered | … | reason=recover_mild_loss` (reversible sprint tuning).
