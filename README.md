...
- **External layer**: operator/agent control JSON is **`control.json`** at the repo root (written via `external_layer/control.py`); see **`external_layer/README.md`** for scope.
